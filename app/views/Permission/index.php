			...
			<div class="content__body _container-main">
                        ...
                        <div class="pallete__body">
                            ...
                            <div class="pellete__block">
                                ...
                                <div class="pallete__list pallete__list_work">
                                    <div class="pallete__item">
                                        <div class="pallete__color pallete__color_aquamarine">
                                    ...
                                    <div class="pallete__item">
                                        <div class="pallete__color pallete__color_wood">
				...
				<div class="filter-content__funcs">
					...
					<form method="post" class="content-search">
						<input type="text" class="input input-search" name="search_info" style="min-width: 200px" value="{{search_info}}" placeholder="Поиск...">
                    ...
                    <form action="" method="post" class="" id="scv-permission">
                        <input type="submit" name="excel-permission" class="input button button-content button-permission button-scv button-permission__space" value="Выгрузить в scv">
                    ...
                    {% endif %}
                    <form action="" method="post" class="hidden" id="view-permission">
                        <input type="submit" name="view-permission" class="input button button-content permission-event button-permission" value="Просмотреть">
                        <input type="text" class="row-id-process" hidden name="id" required id="">
                    </form>
                    ...
                    <form action="" method="post" class="hidden" id="activemasking-permission">
                        <input type="submit" name="activemasking-permission" class="input button button-content permission-event button-permission  button-permission__space" value="Требуется маскирование">
                        <input type="text" class="row-id-process" hidden name="id" required id="">
                    </form>
                    <form action="" method="post" class="hidden" id="unactivemasking-permission">
                        <input type="submit" name="unactivemasking-permission" class="input button button-content permission-event button-permission  button-permission__space" value="Маскирование не требуется">
                        <input type="text" class="row-id-process" hidden name="id" required id="">
                    </form>
                    {% endif %}
                    {% if roles.isDispatcher %}
                    <form action="" method="post" class="hidden" id="activeunmasking-permission">
                        <input type="submit" name="activeunmasking-permission" class="input button button-content permission-event button-permission button-permission__space" value="Требуется демаскирование">
                        <input type="text" class="row-id-process" hidden name="id" required id="">
                    </form>
                    {% endif %}
                    {% if roles.isDispatcher %}
				...
				<div class="content__table">
					<div class="content__table table-content table-permission">
						<div class="table-content__row table-content__row_head table-permission__row_head">
                            ...
                            <div class="table-content__col table-content__head table-permission__head table-permission__subdivision">Периоды работ</div>
                            ...
                            <div class="table-content__col table-content__head table-permission__head table-permission__period">Подразделение</div>
