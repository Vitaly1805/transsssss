                ...
                <div class="permission-add__list">
                    ...
                    <div class="permission-add__item">
                        ...
                        <div class="permission-add__block">
                            ...
                            {% endif %}
                            {% if roles.isAuthor and permission.status_id < 3 %}
                            <a href="http://trans/date" class="permission-add__button input button">Добавить даты</a>
                    ...
                    <div class="permission-add__item">
                        ...
                        {% endif %}
                        {% if roles.isAuthor and permission.status_id < 3 %}
                        <a href="http://trans/type-work" class="permission-add__button permission-add__button_margin input button" style="width: 350px">Выбрать работы</a>
                        {% endif %}
                    </div>
