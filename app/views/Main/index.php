                ...
                <div class="registration__content">
                    ...
                    <div class="registration__block">
                        <div class="input-block">
                            ...
                            <input type="text" name="lastname" value="{{registration.lastname}}" pattern="[А-Яа-яёЁ]{2,100}" placeholder="Введите Вашу фамилию" class="input text-input" required title="Фамилия пользователя должно содержать только кириллические символы. Длина ввода от 2 до 100 символов">
                        </div>
                        <div class="input-block">
                            <label for="name">Имя*</label>
                            <input type="text" name="name" value="{{registration.name}}" pattern="[А-Яа-яёЁ]{2,100}" placeholder="Введите Ваше имя" class="input text-input" id="name" required title="Имя пользователя должно содержать только кириллические символы. Длина ввода от 2 до 100 символов">
                        </div>
                        <div class="input-block">
                            <label for="name">Отчество*</label>
                            <input type="text" name="patronymic" value="{{registration.patronymic}}" pattern="^[А-Яа-яёЁ]{2,100}$" placeholder="Введите Ваше отчество" class="input text-input" required title="Отчество пользователя должно содержать только кириллические символы. Длина ввода от 2 до 100 символов">
                        </div>
                    </div>
                    <div class="registration__subtitle">
...
<!--                                    <option value="2">Инженер</option>-->
                    ...
                    <div class="registration__subdivision">
                        ...
                        <div class="input-block">
                            ...
                            <textarea pattern="[А-Яа-яёЁ]{2,100}" id="textarea-subdivision" readonly class="input valid" title="Выбранное Вами подразделение отобразиться в данном поле" required placeholder="Выберите подразделение" >{{registration.subdivisionName}}</textarea>
                    ...
                    <input type="submit" name="registration" class="input button" value="Зарегистрироваться">
