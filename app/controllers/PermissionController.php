...
class PermissionController extends AppController
{
    ...
    public function indexAction() {
        ...
        } elseif(isset($_POST['view-permission'])) {
            $this->model->viewPermission($_POST['id']);
        ...
        } elseif(isset($_POST['unactivemasking-permission'])) {
    ...
    public function viewAction() {
        ...
        if(isset($_SESSION['idCurrentPermission']) || isset($_SESSION['view-permission'])) {
            $this->setViewVarsToTwig();
        } else {
            $this->model->redirect('permission');
        }
    }

    public function setViewVarsToTwig() {
        $arr = $this->model->getViewVarsToTwig();
